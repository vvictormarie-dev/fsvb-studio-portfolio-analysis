      ...
      <section id="hero" className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            Templates premium optimisés par IA - Livraison en 5 jours ouvrés - Satisfait ou remboursé
          </p>
        ...
        <div className={styles.templatesGrid}>
          ...
          <div className={`glassCard glassCardBordered ${styles.templateCard}`}>
            <div className={styles.templateImageContainer}>
              <img 
                src="/images/digital-agency-web-services-page.webp" 
                alt="Template Site Vitrine Essentiel Preview"
                className={styles.templateImage}
                onError={(e) => {
                  e.currentTarget.src = 'https://via.placeholder.com/400x300?text=Site+Vitrine+Essentiel+Preview';
                }}
              />
              <div className={styles.templateBadge}>Bestseller</div>
            </div>
            <div className={styles.templateContent}>
              <h3 className={styles.templateTitle}>🎨 Site Vitrine Essentiel</h3>
          ...
          <div className={`glassCard glassCardBordered ${styles.templateCard}`}>
            <div className={styles.templateImageContainer}>
              <img 
                src="/images/italian-restaurant-menu-specialties-website.webp" 
          ...
          <div className={`glassCard glassCardBordered ${styles.templateCard}`}>
            <div className={styles.templateImageContainer}>
              <img 
                src="/images/sophie-martin-coaching-website-homepage.webp" 
      ...
      <section id="process" className={styles.section}>
        ...
        <div className={styles.processContainer}>
          ...
          <div className={styles.processStep}>
            ...
            <h3 className={styles.processTitle}>Livraison - 5 jours</h3>
            <p className={styles.processDescription}>
      ...
      <section id="faq" className={styles.section}>
        ...
        <div className={styles.faqGrid}>
          <div className={`glassCard glassCardBordered ${styles.faqItem}`}>
            ...
            <p className={styles.faqAnswer}>5 jours maximum après validation de votre configuration</p>
          </div>
          <div className={`glassCard glassCardBordered ${styles.faqItem}`}>
