...
export interface OrderRecord {
  ...
  payment_source?: 'paypal' | 'comeup' | 'malt' | 'direct'; // NOUVEAU CHAMP
  total_amount?: number;
  stripe_payment_id?: string;
  marketplace_order_id?: string; // NOUVEAU : ID commande marketplace
...
export type PaymentSource = OrderRecord['payment_source']; // NOUVEAU
