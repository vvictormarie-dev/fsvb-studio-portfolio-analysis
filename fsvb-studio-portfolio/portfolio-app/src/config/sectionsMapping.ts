...
export const SECTIONS_MAPPING: Record<string, SectionMapping> = {
  ...
  // ✅ HERO - NOUVEAU: Utilise les champs Hero spécifiques
  hero: {
    id: 'hero',
    label: 'Section Hero',
    formDataFields: {
      title: { source: 'heroTitle', type: 'string' },
      subtitle: { source: 'heroSubtitle', type: 'string' },
      ctaText: { source: 'heroCtaText', type: 'string' },
      ctaButton: { source: 'heroCtaButton', type: 'string' },
      image: { source: 'heroImage', type: 'string' }
    },
    propsMapping: {
      title: 'title',
      subtitle: 'subtitle', 
      primaryCtaText: 'ctaText',
      primaryCtaLabel: 'ctaButton',
      heroImage: 'image'
    },
    useEffect: {
      dependencies: ['heroTitle', 'heroSubtitle', 'heroCtaText', 'heroCtaButton', 'heroImage'],
      condition: 'formData.heroTitle || formData.heroSubtitle'
    },
    notes: 'Nouvelle section Hero avec champs spécifiques'
  },
