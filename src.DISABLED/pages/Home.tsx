  ...
  return (
    <>
      ...
      >
        ...
        `}</style>
          <TemplateCard
            name="Landing Page Solo"
            description="Parfait pour entrepreneurs et freelances en lancement"
            screenshot="https://via.placeholder.com/400x250?text=Landing+Solo"
          ...
          <TemplateCard
            ...
            screenshot="https://via.placeholder.com/400x250?text=Restaurant"
          ...
          <TemplateCard
            ...
            screenshot="https://via.placeholder.com/400x250?text=Coach"
